//
//  WeightInsightWidgetLiveActivity.swift
//  WeightInsightWidget
//
...
struct WeightInsightWidgetAttributes: ActivityAttributes {
...
struct WeightInsightWidgetLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: WeightInsightWidgetAttributes.self) { context in
